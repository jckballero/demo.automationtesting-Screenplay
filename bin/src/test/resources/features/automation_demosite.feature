...
#languaje:es
      ...
      Scenario: Acceder a la Web Automation demo
        ...
        When el realiza el registro en la pagina
          ...
          | Jean Carlos| Caballero | Panama Rep. Panama  | jean1.caballero@mail.com | 4556118813 | Male   | Cricket  | Hockey   | Spanish   | C++        | Aruba   | India         | 1990 | August    | 29  | Abcd1234 | Abcd1234        |
